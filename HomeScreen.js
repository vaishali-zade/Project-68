      ...
      <View>
        ...
        <View>
          ...
          <View style={styles.ratingContainer}>
            ...
            <TouchableOpacity style={styles.buttons} onPress={this.teamA()} onPress={()=> {this.changeScreen('ThankYou')}}>
              <Text style={{ fontSize: 20 }}>Team A</Text>
            </TouchableOpacity>
          
            <TouchableOpacity style={styles.buttons} onPress={this.teamB()} onPress={()=>{this.changeScreen('ThankYou')}}>
